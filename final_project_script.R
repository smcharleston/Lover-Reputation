...
####################  STEP 5: Correlation                ####################   
##################################################################################
plot(data$Chorus_Repeated, data$Title_Repeated)
cor(data$Chorus_Repeated, data$Title_Repeated)

##################################################################################
####################  STEP 6: Linear Regression                ####################   
##################################################################################
linear_relationship <- lm(Chorus_Repeated ~ Title_Repeated, data=data)
...
##################################################################################
plot(data$Chorus_Repeated, residuals (linear_relationship))
abline (h= 0, col = "red")